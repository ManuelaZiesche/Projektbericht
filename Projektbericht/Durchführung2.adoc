...
Bei den Dokumentationen tat sich am Ende der Iteration auch etwas. Sabine Adam fing mit der Anwenderdokumentation an und Manuela Ziesche widmetete sich dem Projektbericht. Wir schrieben noch nicht allzu viel, jedoch fingen wir an, uns mit den Dokumentationen zu beschäftigen und erste Ideen zu sammeln.
...
Am Ende dieser Iteration war es nicht nur wichtig, dass das Team die erledigten und geplanten Aufgaben vergleicht. Wir wollten von unseren Stakeholdern eine positive Rückmeldung bei den Akzeptanztests erhalten. Da das Feedback positiv ausgefallen ist und wir unsere Ziele alle erreicht haben, entschieden wir uns erneut für einen grünen Projektstatus. 
