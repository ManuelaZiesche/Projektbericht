...
Dazu zählte unter anderem der Zustand des Architecture Notebook und die Ausformulierungen der Use Cases. Beide Probleme wurden innerhalb dieser Iteration bearbeitet.
