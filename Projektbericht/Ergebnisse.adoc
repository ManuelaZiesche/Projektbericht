...
<<<
include::reflexion_manuela.adoc[leveloffset=+1]

<<<
include::reflexion_sebastian.adoc[leveloffset=+1]

<<<
include::reflexion_benjamin.adoc[leveloffset=+1]

<<<
include::reflexion_Saputra.adoc[leveloffset=+1]

<<<
include::reflexion_vasco.adoc[leveloffset=+1]

<<<
include::reflexion_sabine.adoc[leveloffset=+1]