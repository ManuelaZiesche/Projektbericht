...
<<<
include::reflexion_manuela.adoc[leveloffset=+2]

<<<
include::reflexion_sebastian.adoc[leveloffset=+2]

<<<
include::reflexion_benjamin.adoc[leveloffset=+2]

<<<
include::reflexion_Saputra.adoc[leveloffset=+2]

<<<
include::reflexion_vasco.adoc[leveloffset=+2]

<<<
include::reflexion_sabine.adoc[leveloffset=+2]